        ...
        <div className="w-3/6 mx-auto border-2 rounded-md my-6 px-8 py-4 bg-white shadow-sm shadow-[#1717171a]">
          ...
          <Info>
            <p>
              ...
              communities. Because our application is open source, you can
              ...
              forem.dev for more information. We believe in transparency and
              adding value to the ecosystem. We hope you enjoy poking around and
              participating!
            </p>
          </Info>
          <Sub sub={"Leadership"} />
          ...
          <Info>
            <p className="text-xl  my-1">
              ...
              the software careers of millions. Happy coding ❤️
            </p>
          </Info>
        </div>
      </div>
