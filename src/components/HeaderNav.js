  ...
  return (
    <nav className="w-screen h-[60px] flex justify-center items-center border-b bg-white">
      <div className="w-[1400px] h-full flex justify-between items-center">
        ...
        <div className="flex">
          {/* logo */}
          <div className="h-[40px] px-2 py-1 flex justify-center items-center bg-black text-slate-200 font-bold rounded cursor-pointer">
        ...
        {/* right */}
        <div>
          <button className="w-[80px] h-[40px] mr-2 px-2 py-1 rounded font-semibold hover:bg-slate-200 hover:underline">
            Login
          </button>
          <button className="w-[130px] h-[40px] px-2 py-1 rounded font-semibold border border-blue-600 text-blue-600 hover:bg-blue-600 hover:text-slate-100 hover:underline">
            Create Account
          </button>
        </div>
      </div>
